      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mt-6 grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <Card className="overflow-hidden rounded-[2rem] p-0">
            <div className="bg-[linear-gradient(135deg,#0f5db8_0%,#0a2f5e_100%)] p-6 text-white md:p-8">
              ...
              <p className="mt-6 text-sm font-semibold text-white/70">Starting From</p>
              <p className="mt-1 text-4xl font-black">{formatCurrency(service.amount)}</p>
              <p className="mt-4 max-w-md text-sm leading-7 text-white/75">{service.description}</p>
            </div>
        ...
        <section className="mt-10 grid gap-6 lg:grid-cols-3">
          <Card className="rounded-2xl p-6 lg:col-span-2">
            <h2 className="text-2xl font-black text-slate-950">What is {service.title}?</h2>
            <p className="mt-4 text-base leading-8 text-slate-600">{content.what}</p>
            ...
            <div className="mt-8 grid gap-5 md:grid-cols-2">
              ...
              <div>
                <h2 className="text-xl font-black text-slate-950">Who Needs It?</h2>
                <div className="mt-4 space-y-3">
        ...
        <section className="mt-10 grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <Card className="rounded-2xl p-6">
            <h2 className="text-2xl font-black text-slate-950">Process Steps</h2>
            <div className="mt-6 space-y-4">
              {processSteps.map((step, index) => (
                <div key={step} className="grid grid-cols-[44px_1fr] gap-4">
                  <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[var(--primary)] text-sm font-black text-white">
                    {index + 1}
                  </div>
          ...
          <Card className="rounded-2xl p-6">
            <h2 className="text-2xl font-black text-slate-950">Image / Proof Section</h2>
        ...
        <section className="mt-10">
          <Card className="rounded-2xl p-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                <h2 className="text-2xl font-black text-slate-950">Rating & Reviews</h2>
              ...
              <div className="flex items-center gap-1 rounded-full bg-orange-50 px-4 py-2 text-orange-600">
                ...
                <span className="ml-2 text-sm font-black">4.9/5</span>
              </div>
            </div>
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              {[
                ...
                <div key={title} className="rounded-2xl bg-slate-50 p-5">
                  ...
                  <p className="mt-2 text-sm leading-7 text-slate-600">{review}</p>
                </div>
              ))}
            </div>
          </Card>
