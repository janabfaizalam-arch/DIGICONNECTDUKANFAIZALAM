...
export default async function ApAssignedWorkPage() {
  ...
  return (
    <main className="min-h-screen px-4 py-6 md:px-8 md:py-10">
      <div className="mx-auto max-w-7xl space-y-6">
        <div>
          <p className="text-sm font-bold uppercase tracking-[0.18em] text-[var(--secondary)]">Partner Work</p>
                ...
                >
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-600">
                      {application.service_name} | {getCustomerMobile(application) || "No mobile"}
                    </p>
