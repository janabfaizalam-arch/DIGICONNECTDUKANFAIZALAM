      ...
      <div className="container-shell rounded-3xl border bg-white/90 p-6 shadow-soft md:p-10">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-bold text-slate-950 md:text-4xl">Visit DigiConnect Dukan in Orai or Jalaun</h2>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-[1.75rem] bg-[var(--muted)] p-6">
              ...
              <p className="mt-4 text-sm font-medium text-slate-500">Office 1</p>
            ...
            <div className="rounded-[1.75rem] bg-[var(--accent)] p-6">
              ...
              <p className="mt-4 text-sm font-medium text-slate-500">Office 2</p>
            ...
            <div className="rounded-[1.75rem] border p-6">
              ...
              <p className="mt-4 text-sm font-medium text-slate-500">Primary Call / Customer Care</p>
