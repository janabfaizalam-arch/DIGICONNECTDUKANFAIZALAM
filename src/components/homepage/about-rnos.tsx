  ...
  return (
    <HomepageSection id="about" surface="navy" aria-labelledby="about-heading">
      <div className="grid items-center gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div>
          <p className="inline-flex items-center gap-1.5 text-[11px] font-extrabold uppercase tracking-[0.18em] text-[var(--dc-amber)]">
            <Building2 className="h-3.5 w-3.5" aria-hidden="true" /> Company
          </p>
          <h2 id="about-heading" className="mt-2 text-[1.65rem] font-extrabold tracking-[-0.025em] text-white sm:text-[2rem] md:text-[2.25rem]">
            About RNOS / DigiConnect Dukan
          </h2>
          <p className="mt-3 max-w-2xl text-[15px] font-medium leading-relaxed text-white/80 sm:text-base">
          ...
          <ul className="mt-5 space-y-2 text-sm font-semibold text-white/85 sm:text-[15px]">
            <li className="flex items-start gap-2">
              <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-[var(--dc-amber)]" aria-hidden="true" />
              Service coverage: {contactDetails.availability}
            </li>
            <li>
              Support:{" "}
              <a className="font-bold text-[var(--dc-amber)] hover:underline" href={`mailto:${contactDetails.email}`}>
        ...
        <div className="lg-card-dark p-5">
