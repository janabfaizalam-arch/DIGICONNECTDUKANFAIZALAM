...
export function QuickServiceGrid() {
  return (
    <section className="bg-white px-3 py-6 md:px-6">
      {/* Wave floating animations defined scoped */}
      <style jsx global>{`
        @keyframes float-soft-3d {
          0%, 100% {
        ...
        .anim-float-3d-1 { animation: float-soft-3d 3.8s ease-in-out infinite; }
        .anim-float-3d-2 { animation: float-soft-3d 3.8s ease-in-out infinite 0.4s; }
        .anim-float-3d-3 { animation: float-soft-3d 3.8s ease-in-out infinite 0.8s; }
        .anim-float-3d-4 { animation: float-soft-3d 3.8s ease-in-out infinite 1.2s; }
        .anim-float-3d-5 { animation: float-soft-3d 3.8s ease-in-out infinite 1.6s; }
        .anim-float-3d-6 { animation: float-soft-3d 3.8s ease-in-out infinite 2.0s; }
        .anim-float-3d-7 { animation: float-soft-3d 3.8s ease-in-out infinite 2.4s; }
        .anim-float-3d-8 { animation: float-soft-3d 3.8s ease-in-out infinite 2.8s; }
      `}</style>
      ...
      <div className="container-shell">
        <div className="rounded-[2.25rem] border border-blue-50/70 bg-[linear-gradient(135deg,rgba(255,255,255,0.78),rgba(255,255,255,0.48))] p-5 shadow-[0_12px_36px_rgba(7,19,38,0.03)] backdrop-blur-md">
          ...
          <div className="grid grid-cols-3 gap-y-6 gap-x-2.5 sm:grid-cols-4 md:grid-cols-8 md:gap-x-4">
            ...
            {/* 1. GST */}
            <Link href="/services/gst-registration-filing" className="group flex flex-col items-center text-center active:scale-95 transition anim-float-3d-1">
              <div className="w-16 h-16 md:w-[72px] md:h-[72px] rounded-2xl flex items-center justify-center border border-white/60 bg-gradient-to-tr from-emerald-500/10 to-teal-500/5 shadow-[0_6px_20px_rgba(16,185,129,0.06)] group-hover:scale-105 group-hover:shadow-[0_8px_24px_rgba(16,185,129,0.14)] transition-all duration-300">
            ...
            {/* 2. ITR */}
            <Link href="/services/itr-filing" className="group flex flex-col items-center text-center active:scale-95 transition anim-float-3d-2">
              <div className="w-16 h-16 md:w-[72px] md:h-[72px] rounded-2xl flex items-center justify-center border border-white/60 bg-gradient-to-tr from-blue-500/10 to-indigo-500/5 shadow-[0_6px_20px_rgba(37,99,235,0.06)] group-hover:scale-105 group-hover:shadow-[0_8px_24px_rgba(37,99,235,0.14)] transition-all duration-300">
                <svg width="34" height="34" viewBox="0 0 64 64" fill="none">
            ...
            {/* 3. Passport */}
            <Link href="/services/passport" className="group flex flex-col items-center text-center active:scale-95 transition anim-float-3d-3">
              <div className="w-16 h-16 md:w-[72px] md:h-[72px] rounded-2xl flex items-center justify-center border border-white/60 bg-gradient-to-tr from-purple-500/10 to-indigo-500/5 shadow-[0_6px_20px_rgba(139,92,246,0.06)] group-hover:scale-105 group-hover:shadow-[0_8px_24px_rgba(139,92,246,0.14)] transition-all duration-300">
                <svg width="34" height="34" viewBox="0 0 64 64" fill="none">
            ...
            {/* 4. Licence */}
            <Link href="/services/learning-driving-license" className="group flex flex-col items-center text-center active:scale-95 transition anim-float-3d-4">
              <div className="w-16 h-16 md:w-[72px] md:h-[72px] rounded-2xl flex items-center justify-center border border-white/60 bg-gradient-to-tr from-cyan-500/10 to-teal-500/5 shadow-[0_6px_20px_rgba(6,182,212,0.06)] group-hover:scale-105 group-hover:shadow-[0_8px_24px_rgba(6,182,212,0.14)] transition-all duration-300">
                <svg width="34" height="34" viewBox="0 0 64 64" fill="none">
            ...
            {/* 5. Insurance */}
            <Link href="/services/insurance" className="group flex flex-col items-center text-center active:scale-95 transition anim-float-3d-5">
              <div className="w-16 h-16 md:w-[72px] md:h-[72px] rounded-2xl flex items-center justify-center border border-white/60 bg-gradient-to-tr from-sky-500/10 to-blue-500/5 shadow-[0_6px_20px_rgba(14,165,233,0.06)] group-hover:scale-105 group-hover:shadow-[0_8px_24px_rgba(14,165,233,0.14)] transition-all duration-300">
                <svg width="34" height="34" viewBox="0 0 64 64" fill="none">
            ...
            {/* 6. CIBIL */}
            <Link href="/services/cibil-report-analysis-and-credit-health-consultation" className="group flex flex-col items-center text-center active:scale-95 transition anim-float-3d-6">
              <div className="w-16 h-16 md:w-[72px] md:h-[72px] rounded-2xl flex items-center justify-center border border-white/60 bg-gradient-to-tr from-orange-500/10 to-amber-500/5 shadow-[0_6px_20px_rgba(249,115,22,0.06)] group-hover:scale-105 group-hover:shadow-[0_8px_24px_rgba(249,115,22,0.14)] transition-all duration-300">
                <svg width="34" height="34" viewBox="0 0 64 64" fill="none">
            ...
            {/* 7. PVC Card */}
            <Link href="/services/pvc-card" className="group flex flex-col items-center text-center active:scale-95 transition anim-float-3d-7">
              <div className="w-16 h-16 md:w-[72px] md:h-[72px] rounded-2xl flex items-center justify-center border border-white/60 bg-gradient-to-tr from-cyan-500/10 to-indigo-500/5 shadow-[0_6px_20px_rgba(6,182,212,0.06)] group-hover:scale-105 group-hover:shadow-[0_8px_24px_rgba(6,182,212,0.14)] transition-all duration-300">
                <svg width="34" height="34" viewBox="0 0 64 64" fill="none">
            ...
            {/* 8. All Services */}
            <Link href="/services" className="group flex flex-col items-center text-center active:scale-95 transition anim-float-3d-8">
              <div className="w-16 h-16 md:w-[72px] md:h-[72px] rounded-2xl flex items-center justify-center border border-white/60 bg-gradient-to-tr from-rose-500/10 to-pink-500/5 shadow-[0_6px_20px_rgba(244,63,94,0.06)] group-hover:scale-105 group-hover:shadow-[0_8px_24px_rgba(244,63,94,0.14)] transition-all duration-300">
                <svg width="34" height="34" viewBox="0 0 64 64" fill="none">
