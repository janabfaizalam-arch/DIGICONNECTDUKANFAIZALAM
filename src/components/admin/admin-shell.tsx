...
import { BadgePercent, BarChart3, BellRing, BriefcaseBusiness, FileText, GalleryHorizontalEnd, Gift, Images, LayoutDashboard, LogOut, Newspaper, Settings, ShieldCheck, UserCog, UsersRound, WalletCards } from "lucide-react";
...
const adminLinks = [
  ...
  { href: "/admin/insurance-quotations", label: "Insurance Quotations", icon: ShieldCheck },
  { href: "/admin/homepage-notices", label: "Homepage Notices", icon: BellRing },
  { href: "/admin/homepage-slides", label: "Homepage Slides", icon: Images },
