...
import { BadgePercent, BarChart3, BriefcaseBusiness, FileText, GalleryHorizontalEnd, Gift, Images, LayoutDashboard, LogOut, Newspaper, Settings, UserCog, UsersRound, WalletCards } from "lucide-react";
