...
import { BadgePercent, BarChart3, BellRing, BriefcaseBusiness, FileText, GalleryHorizontalEnd, Gift, Images, LayoutDashboard, LogOut, Newspaper, Settings, UserCog, UsersRound, WalletCards } from "lucide-react";
