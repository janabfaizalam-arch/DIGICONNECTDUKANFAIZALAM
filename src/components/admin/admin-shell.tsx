...
import { BadgePercent, BarChart3, FileText, GalleryHorizontalEnd, Gift, Images, LayoutDashboard, LogOut, Newspaper, Settings, UserCog, UsersRound, WalletCards } from "lucide-react";
