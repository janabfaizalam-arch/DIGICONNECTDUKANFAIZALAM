...
function applicationToAdminRow(application: Application, agentsById: Record<string, PortalUser>, staffById: Record<string, PortalUser>): AdminApplicationRow {
  ...
  return {
    ...
    razorpay_order_id: payment?.razorpay_order_id ?? application.razorpay_order_id ?? null,
    razorpay_payment_id: payment?.razorpay_payment_id ?? application.razorpay_payment_id ?? null,
