/**
 * Client-safe admin login helpers (types, UI error mapping, pure selection).
 * Must never import native hashing, service-role clients, cookies, or DB repair modules.
 */

import { normalizeStoredMobile } from "@/lib/auth/mobile";
